...
- `frontend-file-architecture.md`: architecture cible et plan de migration frontend
- `local-admin-rebac-hotfix.sql`: hotfix minimal des permissions ADMIN (dev)
- `local-admin-rebac-full-dev.sql`: hotfix complet ReBAC pour debloquer les tests en dev
